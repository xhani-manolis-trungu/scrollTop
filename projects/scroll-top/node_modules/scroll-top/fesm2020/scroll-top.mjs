...
ScrollTopComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ScrollTopComponent, selectors: [["lib-scroll-top"]], inputs: { elementId: "elementId" }, features: [i0.ɵɵProvidersFeature([ScrollTopDirective])], decls: 1, vars: 0, consts: [[1, "scroll-top"]], template: function ScrollTopComponent_Template(rf, ctx) { if (rf & 1) {
        i0.ɵɵelement(0, "div", 0);
    } }, encapsulation: 2 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ScrollTopComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(ScrollTopModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    ScrollTopComponent,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(ScrollTopModule, { declarations: [ScrollTopComponent,
